...
export const PROVIDERS = {
  ...
  claude: {
    ...
    defaults: { apiKey: "", model: "claude-sonnet-4-6", temperature: 0.7, batchSize: 20, contextWindow: 100, enableThinking: false, useRelay: false },
  },
  gemini: {
    kind: "custom",
    category: "llm",
    ...
    defaults: { apiKey: "", model: "gemini-3-flash", temperature: 0.7, batchSize: 20, contextWindow: 100 },
  },
  qwen: {
    kind: "openai-compat",
    category: "llm",
  ...
  nvidia: {
    ...
    defaults: { url: "", apiKey: "", model: "deepseek-ai/deepseek-v3.2", temperature: 0.7, batchSize: 20, contextWindow: 100, enableThinking: false },
  },
  azureopenai: {
    kind: "custom",
    category: "aggregator",
    ...
    defaults: { url: "", apiKey: "", model: "gpt-5-mini", apiVersion: "2025-11-18", temperature: 0.7, batchSize: 20, contextWindow: 100 },
  },
  llm: {
    kind: "custom",
    category: "aggregator",
    label: "Custom LLM",
    defaults: { url: "http://127.0.0.1:11434/v1/chat/completions", apiKey: "", model: "llama3.2", temperature: 0.7, batchSize: 20, contextWindow: 100 },
  },
